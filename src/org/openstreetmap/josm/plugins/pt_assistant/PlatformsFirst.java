...
public class PlatformsFirst extends Test { // TODO: this class will need to be renamed
    		...
    		for (RelationMember currMember: members) {
    			if (prevMember != null) {
    				...
    				if (currMember.hasRole("platform") && prevMember.getType().equals(OsmPrimitiveType.WAY)) {
    					errors.add(new TestError(this, Severity.WARNING, tr("PT: route relation(s) contain(s) way(s) before platform(s) in the members list"), 9999, r));
    	                return;
    				}
    			} 
